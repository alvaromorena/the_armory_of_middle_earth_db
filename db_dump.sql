...
-- data: data
INSERT INTO data (id, unit, amount, painted, type, allegiance, version, date_added, status, image_path) VALUES (51,'Aragorn (Strider)',1,1,'Hero','The fellowship','Plastic version from moria set','2025-11-03','Completed',NULL);
INSERT INTO data (id, unit, amount, painted, type, allegiance, version, date_added, status, image_path) VALUES (52,'Gildor Inglorion',0,0,'Hero','Rivendell',NULL,'2025-11-03','Missing',NULL);
INSERT INTO data (id, unit, amount, painted, type, allegiance, version, date_added, status, image_path) VALUES (53,'Frodo',1,1,'Hero','The fellowship','Plastic version from moria set','2025-11-03','Completed',NULL);
INSERT INTO data (id, unit, amount, painted, type, allegiance, version, date_added, status, image_path) VALUES (54,'Sam',1,1,'Hero','The fellowship','Plastic version from moria set','2025-11-03','Completed',NULL);
INSERT INTO data (id, unit, amount, painted, type, allegiance, version, date_added, status, image_path) VALUES (55,'Merry',1,1,'Hero','The fellowship','Plastic version from moria set','2025-11-03','Completed',NULL);
INSERT INTO data (id, unit, amount, painted, type, allegiance, version, date_added, status, image_path) VALUES (56,'Pippin',1,1,'Hero','The fellowship','Plastic version from moria set','2025-11-03','Completed',NULL);
INSERT INTO data (id, unit, amount, painted, type, allegiance, version, date_added, status, image_path) VALUES (57,'Pippin',1,0,'Hero','The fellowship','Weathertop Box','2025-11-03','Assembled',NULL);
INSERT INTO data (id, unit, amount, painted, type, allegiance, version, date_added, status, image_path) VALUES (58,'Merry',1,0,'Hero','The fellowship','Weathertop Box','2025-11-03','Assembled',NULL);
INSERT INTO data (id, unit, amount, painted, type, allegiance, version, date_added, status, image_path) VALUES (59,'Frodo',1,0,'Hero','The fellowship','Weathertop Box','2025-11-03','Assembled',NULL);
INSERT INTO data (id, unit, amount, painted, type, allegiance, version, date_added, status, image_path) VALUES (60,'Sam',1,0,'Hero','The fellowship','Weathertop Box','2025-11-03','Assembled',NULL);
INSERT INTO data (id, unit, amount, painted, type, allegiance, version, date_added, status, image_path) VALUES (61,'Ringwraith',5,5,'Hero','Mordor','On foot','2025-11-03','Completed',NULL);
INSERT INTO data (id, unit, amount, painted, type, allegiance, version, date_added, status, image_path) VALUES (62,'Aragorn (Strider)',1,0,'Hero','The fellowship','Weathertop Box','2025-11-03','Assembled',NULL);
INSERT INTO data (id, unit, amount, painted, type, allegiance, version, date_added, status, image_path) VALUES (63,'Saruman',1,0,'Hero','Isengard','Plastic version','2025-11-03','Assembled',NULL);
INSERT INTO data (id, unit, amount, painted, type, allegiance, version, date_added, status, image_path) VALUES (64,'Saruman',1,1,'Hero','Isengard','Metal','2025-11-03','Completed',NULL);
INSERT INTO data (id, unit, amount, painted, type, allegiance, version, date_added, status, image_path) VALUES (65,'Grima Wormtonge',1,0,'Hero','Isengard','Plastic version','2025-11-03','Assembled',NULL);
INSERT INTO data (id, unit, amount, painted, type, allegiance, version, date_added, status, image_path) VALUES (66,'Saruman',1,0,'Hero','Isengard','(On horse)','2025-11-03','Assembled',NULL);
INSERT INTO data (id, unit, amount, painted, type, allegiance, version, date_added, status, image_path) VALUES (67,'Treebeard',1,1,'Hero','Fangorn','Metal','2025-11-03','Completed',NULL);
INSERT INTO data (id, unit, amount, painted, type, allegiance, version, date_added, status, image_path) VALUES (68,'Ent',1,1,'Monster','Fangorn',NULL,'2025-11-03','Completed',NULL);
INSERT INTO data (id, unit, amount, painted, type, allegiance, version, date_added, status, image_path) VALUES (69,'Bilbo',1,1,'Hero','The shire',NULL,'2025-11-03','Completed',NULL);
INSERT INTO data (id, unit, amount, painted, type, allegiance, version, date_added, status, image_path) VALUES (70,'Gandalf',1,1,'Hero','The shire','(On cart)','2025-11-03','Completed',NULL);
INSERT INTO data (id, unit, amount, painted, type, allegiance, version, date_added, status, image_path) VALUES (71,'Troll',1,0,'Monster','Moria','(with spear) Plastic Version','2025-11-03','Assembled',NULL);
INSERT INTO data (id, unit, amount, painted, type, allegiance, version, date_added, status, image_path) VALUES (72,'Gimli',1,0,'Hero','The fellowship','(on dead Uruk-hai)','2025-11-03','Assembled',NULL);
INSERT INTO data (id, unit, amount, painted, type, allegiance, version, date_added, status, image_path) VALUES (73,'Gimli',1,1,'Hero','The fellowship','Plastic version from moria set','2025-11-03','Completed',NULL);
INSERT INTO data (id, unit, amount, painted, type, allegiance, version, date_added, status, image_path) VALUES (74,'Legolas',1,1,'Hero','The fellowship','Plastic version from moria set','2025-11-03','Completed',NULL);
INSERT INTO data (id, unit, amount, painted, type, allegiance, version, date_added, status, image_path) VALUES (75,'Boromir',1,1,'Hero','The fellowship','Plastic version from moria set','2025-11-03','Completed',NULL);
INSERT INTO data (id, unit, amount, painted, type, allegiance, version, date_added, status, image_path) VALUES (76,'Gandalf',1,1,'Hero','The fellowship','Plastic version from moria set','2025-11-03','Completed',NULL);
INSERT INTO data (id, unit, amount, painted, type, allegiance, version, date_added, status, image_path) VALUES (77,'Farmer Maggot',1,0,'Hero','The shire',NULL,'2025-11-03','On Sprue',NULL);
INSERT INTO data (id, unit, amount, painted, type, allegiance, version, date_added, status, image_path) VALUES (78,'Uruk-hai Scout',8,8,'Infantry','Isengard','(No additional equipment)','2025-11-04','Completed',NULL);
INSERT INTO data (id, unit, amount, painted, type, allegiance, version, date_added, status, image_path) VALUES (79,'Uruk-hai Scout',8,8,'Infantry','Isengard','(With bow)','2025-11-04','Completed',NULL);
INSERT INTO data (id, unit, amount, painted, type, allegiance, version, date_added, status, image_path) VALUES (80,'Uruk-hai Scout',8,8,'Infantry','Isengard','(With shield)','2025-11-04','Completed',NULL);
INSERT INTO data (id, unit, amount, painted, type, allegiance, version, date_added, status, image_path) VALUES (81,'Tom Bombadil',1,0,'Hero','Free people',NULL,'2025-11-04','Sealed',NULL);
INSERT INTO data (id, unit, amount, painted, type, allegiance, version, date_added, status, image_path) VALUES (82,'Goldberry',1,0,'Hero','Free people',NULL,'2025-11-04','Sealed',NULL);
INSERT INTO data (id, unit, amount, painted, type, allegiance, version, date_added, status, image_path) VALUES (83,'Uruk-hai Warrior',10,10,'Infantry','Isengard','(With shield)','2025-11-04','Completed',NULL);
INSERT INTO data (id, unit, amount, painted, type, allegiance, version, date_added, status, image_path) VALUES (84,'Uruk-hai Warrior',10,10,'Infantry','Isengard','(With pike)','2025-11-04','Completed',NULL);
INSERT INTO data (id, unit, amount, painted, type, allegiance, version, date_added, status, image_path) VALUES (85,'Uruk-hai Warrior Captain',1,1,'Hero','Isengard',NULL,'2025-11-04','Completed',NULL);
INSERT INTO data (id, unit, amount, painted, type, allegiance, version, date_added, status, image_path) VALUES (86,'Lurtz, Uruk-hai Scout Captain',1,1,'Hero','Isengard','Metal','2025-11-04','Completed',NULL);
INSERT INTO data (id, unit, amount, painted, type, allegiance, version, date_added, status, image_path) VALUES (87,'Ugluk, Uruk-hai Scout Captain',1,1,'Hero','Isengard',NULL,'2025-11-04','Completed',NULL);
INSERT INTO data (id, unit, amount, painted, type, allegiance, version, date_added, status, image_path) VALUES (88,'King of the dead',1,1,'Hero','Dunharrow','Plastic version','2025-11-04','Completed',NULL);
INSERT INTO data (id, unit, amount, painted, type, allegiance, version, date_added, status, image_path) VALUES (89,'Herald of the dead',2,2,'Hero','Dunharrow','Plastic version','2025-11-04','Completed',NULL);
INSERT INTO data (id, unit, amount, painted, type, allegiance, version, date_added, status, image_path) VALUES (90,'Warrior of the dead',4,4,'Infantry','Dunharrow','(With spear)','2025-11-04','Completed',NULL);
INSERT INTO data (id, unit, amount, painted, type, allegiance, version, date_added, status, image_path) VALUES (91,'Warrior of the dead',2,2,'Infantry','Dunharrow','(With shield and spear)','2025-11-04','Completed',NULL);
INSERT INTO data (id, unit, amount, painted, type, allegiance, version, date_added, status, image_path) VALUES (92,'Warrior of the dead',14,14,'Infantry','Dunharrow','(With shield)','2025-11-04','Completed',NULL);
INSERT INTO data (id, unit, amount, painted, type, allegiance, version, date_added, status, image_path) VALUES (93,'Uruk-hai Berserker',12,0,'Infantry','Isengard',NULL,'2025-11-04','Assembled',NULL);
INSERT INTO data (id, unit, amount, painted, type, allegiance, version, date_added, status, image_path) VALUES (94,'Uruk-hai Warrior',6,0,'Infantry','Isengard','(With crossbow)','2025-11-04','Assembled',NULL);
INSERT INTO data (id, unit, amount, painted, type, allegiance, version, date_added, status, image_path) VALUES (95,'Mordor orc',1,0,'Infantry','Mordor','(With Banner)','2025-11-04','Assembled',NULL);
INSERT INTO data (id, unit, amount, painted, type, allegiance, version, date_added, status, image_path) VALUES (96,'Uruk-hai Warrior',1,0,'Infantry','Isengard','(With Banner)','2025-11-04','Assembled',NULL);
INSERT INTO data (id, unit, amount, painted, type, allegiance, version, date_added, status, image_path) VALUES (97,'Barrow-wights',2,0,'Hero','Angmar',NULL,'2025-11-04','Sealed',NULL);
INSERT INTO data (id, unit, amount, painted, type, allegiance, version, date_added, status, image_path) VALUES (98,'Ringwraith',2,0,'Hero','Mordor','(On horse)','2025-11-04','On Sprue',NULL);
INSERT INTO data (id, unit, amount, painted, type, allegiance, version, date_added, status, image_path) VALUES (99,'Barliman Butterbur',1,0,'Hero','The shire',NULL,'2025-11-04','Sealed',NULL);
INSERT INTO data (id, unit, amount, painted, type, allegiance, version, date_added, status, image_path) VALUES (100,'Harry Goatleaf',1,0,'Hero','The shire',NULL,'2025-11-04','Sealed',NULL);
SELECT setval('data_id_seq', 100, true);

-- data: scenarios
INSERT INTO scenarios (id, name, book, page, description, map_size, image_path) VALUES (1,'Weathertop','Quest of the ringbearer',22,$q08a366a7c9$After fleeing the Black Riders in Bree, the Hobbits have had to put their faith in the mysterious traveller known as Strider who aided their escape. With Gandalf not having been at the Prancing Pony, the Hobbits must now follow Strider to Rivendell in order to keep the Ring safe and prevent the Black Riders from finding them and reclaiming the Ring for the Dark Lord. As they continue to walk eastwards across country, Aragorn and the Hobbits stop to rest within the old ruined watchtower of Amon Sul. This former seat of power once held one of the Palantiri in the times of Elendil, though many years of war and ruin have seen it abandoned and in disrepair. Weathertop, as it is now known, would make an ideal place to set up camp away from prying eyes, and whilst the Hobbits rest, Strider goes off to forage for food.\n\nYet, Strider has been away for some time scouting the lands around Weathertop, and Hobbits never were ones to go without food for too long if they can help it. In the depths of night, the Hobbits'' hunger provokes them to start a small fire in the hope of cooking a quick meal of tomatoes, sausages and some nice crispy bacon as a means to fill them up and prevent their stomachs from constantly rumbling. However, their innocent endeavour has had some dire consequences and has given away their location to the pursuing Ringwraiths, who now head straight towards the ruins of the watchtower of Amon Sul. Huddled together within the centre of Weathertop, the terrified Hobbits are faced with the shrouded figures of the Nazgul, and the terrible fate that awaits them if Strider cannot reach them in time...$q08a366a7c9$,'2x2 ft',NULL);
INSERT INTO scenarios (id, name, book, page, description, map_size, image_path) VALUES (2,'Farmer Maggots crop','Quest of the ringbearer',10,$q9c9362a266$Farmer Maggot is a well-respected member of the Shire community. A stubborn and practical fellow who devotes his time to the crops that he grows rather than to the other goings-on in the Shire. It is said that Maggot''s crops are the best in all the four Farthings. His carrots are without peer, his cabbages tastier than any others, but it is his mushrooms that are the pride of Maggot''s crop. Envied across the Shire, especially as all Hobbits are rather fond of mushrooms.
...
In truth, the riders in black are far closer than Frodo and his companions realise, constantly stalking the paths of the forest in their search for the one who carries the Ring. Should the Nazguls'' search prove fruitful and they find the Baggins that carries their master''s prize, they will not hesitate to kill him and take the Ring for Sauron.$q3a82eb7284$,'4x4 ft',NULL);
INSERT INTO scenarios (id, name, book, page, description, map_size, image_path) VALUES (4,'Buckleberry Ferry','Quest of the ringbearer',14,$q5c3c41856f$Having once evaded the Black Riders, and spent some time resting with Gildor and his Elves, the Hobbits find themselves back on their journey towards Crickhollow. Once more heeding Gandalf''s words to stay off the road, the Hobbits are travelling through the densely wooded areas of Buckland just in case any more of these mysterious riders in black may yet be tracking them.
...
The Hobbits know they must escape the Black Riders and quickly, and the only way to put some meaningful distance between them and their pursuers is to cross the Brandywine River using the Buckleberry Ferry. However, the Nazgul stand between them and the relative safety of the ferry, so to reach it the Hobbits will have to use every ounce of stealth, and no small amount of luck, to make it to the ferry undetected.$q5c3c41856f$,'4x4 ft',NULL);
INSERT INTO scenarios (id, name, book, page, description, map_size, image_path) VALUES (5,'The old forest','Quest of the ringbearer',16,$qa90916b812$Having evaded the Black Riders for the time being, the Hobbits have reached Frodo''s new home of Crickhollow. Stopping for the night to sleep, stock up on provisions, and above all, have a large well-earned meal, Frodo and his companions are in good spirits as they leave the comfort of Crickhollow in the hands of their friend Fredegar Bolger, and set off east once more.
