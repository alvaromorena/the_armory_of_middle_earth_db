...
-- data: data
INSERT INTO data (unit, amount, painted, type, allegiance, version, date_added, status) VALUES ('Aragorn (Strider)','1','1','Hero','The fellowship','Plastic version from moria set','2025-11-03','Completed');
...
-- data: scenarios
INSERT INTO scenarios (name, book, page, description, map_size) VALUES ('Weathertop','Quest of the ringbearer','22','After fleeing the Black Riders in Bree, the Hobbits have had to put their faith in the mysterious traveller known as Strider who aided their escape. With Gandalf not having been at the Prancing Pony, the Hobbits must now follow Strider to Rivendell in order to keep the Ring safe and prevent the Black Riders from finding them and reclaiming the Ring for the Dark Lord.
 ...
 However, their innocent endeavour has had some dire consequences and has given away their location to the pursuing Ringwraiths, who now head straight towards the ruins of the watchtower of Amon Sul. Huddled together within the centre of Weathertop, the terrified Hobbits are faced with the shrouded figures of the Nazgul, and the terrible fate that awaits them if Strider cannot reach them in time...','2x2 ft');
...
In truth, the riders in black are far closer than Frodo and his companions realise, constantly stalking the paths of the forest in their search for the one who carries the Ring. Should the Nazguls'''' search prove fruitful and they find the Baggins that carries their master''''s prize, they will not hesitate to kill him and take the Ring for Sauron.','4x4 ft');
INSERT INTO scenarios (name, book, page, description, map_size) VALUES ('Buckleberry Ferry','Quest of the ringbearer','14','Having once evaded the Black Riders, and spent some time resting with Gildor and his Elves, the Hobbits find themselves back on their journey towards Crickhollow. Once more heeding Gandalf''''s words to stay off the road, the Hobbits are travelling through the densely wooded areas of Buckland just in case any more of these mysterious riders in black may yet be tracking them.
...
The Hobbits know they must escape the Black Riders and quickly, and the only way to put some meaningful distance between them and their pursuers is to cross the Brandywine River using the Buckleberry Ferry. However, the Nazgul stand between them and the relative safety of the ferry, so to reach it the Hobbits will have to use every ounce of stealth, and no small amount of luck, to make it to the ferry undetected.','4x4 ft');
INSERT INTO scenarios (name, book, page, description, map_size) VALUES ('The old forest','Quest of the ringbearer','16','Having evaded the Black Riders for the time being, the Hobbits have reached Frodo''''s new home of Crickhollow. Stopping for the night to sleep, stock up on provisions, and above all, have a large well-earned meal, Frodo and his companions are in good spirits as they leave the comfort of Crickhollow in the hands of their friend Fredegar Bolger, and set off east once more.
